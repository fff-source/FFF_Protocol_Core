...
#ifndef FFF_CLIENTVERSION_H
#define FFF_CLIENTVERSION_H
...
//! These need to be macros, as clientversion.cpp's and FFF*-res.rc's voodoo requires it
...
/* MCHN END */
/**
 * FFFd-res.rc includes this file, but it cannot cope with real c++ code.
