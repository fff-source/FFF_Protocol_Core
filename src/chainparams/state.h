...
#ifndef FFF_Core_STATE_H
#define	FFF_Core_STATE_H

#include "utils/define.h"
#include "chainparams/params.h"
#include "protocol/FFF_Corescript.h"
...
{    
    const mc_OneFFF_CoreParam *m_Param;
    int64_t m_Value;    
    uint32_t m_Block;
    int32_t m_Skipped; 
...
{    
    ...
    mc_Params               *m_Params;
    mc_FFF_CoreParams     *m_NetworkParams;
    ...
    void  InitDefaults()
    {
        ...
        m_NetworkParams=new mc_FFF_CoreParams;
        m_Permissions=NULL;
        m_Assets=NULL;
