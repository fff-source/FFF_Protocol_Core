...
#ifndef FFF_CorePARAMLIST_H
#define FFF_CorePARAMLIST_H

static const mc_OneFFF_CoreParam FFF_CoreParamArray[] =
{
    { "chainprotocol"                          , "chain-protocol"                          ,
                   ...
                   "Chain protocol: FFF_Core (permissions, native assets) or FFF"},
...
*/                   
    ...
    { "chainname"                              , "chain-name"                              ,
                   ...
                   "protocolversion","",
                   "Chain name, used as first argument for FFF_Cored and FFF_Core-cli."},                   
