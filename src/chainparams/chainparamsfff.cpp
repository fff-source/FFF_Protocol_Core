...
/* MCHN START */
static Checkpoints::MapCheckpoints mapCheckpointsFFF_Core =
        boost::assign::map_list_of
        ( -1, uint256("0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"))
        ;
static const Checkpoints::CCheckpointData dataFFF_Core = {
        &mapCheckpointsFFF_Core,
        0,
        0,
        0
    };
...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("FFF.sipa.be", "seed.FFF.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.FFF.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("FFFstats.com", "seed.FFFstats.com"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("FFF.petertodd.org", "testnet-seed.FFF.petertodd.org"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "testnet-seed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("FFF.schildbach.de", "testnet-seed.FFF.schildbach.de"));
...
class CFFF_CoreParams : public CMainParams {
public:
    CFFF_CoreParams() {    };
    
    void SetFixedParams(const char *NetworkName)
    {
        networkID = CBaseChainParams::FFF_Core;
...
static CFFF_CoreParams FFF_CoreParams;


bool SelectFFF_CoreParams(const char *NetworkName)
{
    SelectFFF_CoreBaseParams(NetworkName,(int)mc_gState->m_NetworkParams->GetInt64Param("defaultrpcport"));

    FFF_CoreParams.SetFixedParams(NetworkName);
    
    FFF_CoreParams.Initialize();
    
    pCurrentParams = &FFF_CoreParams;
...
void SetFFF_CoreParams()
{
    FFF_CoreParams.SetFFF_CoreParams();
}

void SetFFF_CoreParam(const char*param_name,int64_t value)
{
    FFF_CoreParams.SetFFF_CoreParam(param_name,value);
}


void SetFFF_CoreRuntimeParams()
{
    FFF_CoreParams.SetFFF_CoreRuntimeParams();
}
