...
void FFF_CoreNode_AddSignatureToCache(const std::vector<unsigned char>& vchSig, const CPubKey& pubkey, const uint256& sighash);
...
/* MCHN END */    
    ...
    {
        FFF_CoreNode_AddSignatureToCache(vchSig,key.GetPubKey(),hash);
    }
