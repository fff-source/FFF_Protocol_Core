...
int main(int argc, char* argv[])
{
    ...
    mc_FFF_CoreParams* params;
    mc_FFF_CoreParams* paramsOld;
...
//                    err=params->Create(mc_gState->m_Params->m_Arguments[1],version);
                ...
                { 
                    ...
                    printf("You can edit it in %s before running FFF_Cored for the first time.\n\n",fileName);
                    printf("To generate blockchain please run \"FFF_Cored %s -daemon\".\n",params->Name());
                }                
                else
                {
        ...
        if(strcmp(mc_gState->m_Params->Command(),"clone") == 0)
        {
            ...
            {
                params=new mc_FFF_CoreParams;
                paramsOld=new mc_FFF_CoreParams;
...
*/        
    ...
    if(err == MC_ERR_OPERATION_NOT_SUPPORTED)
    {
        ...
        printf("Usage:\n");
        printf("  FFF_Core-util create <blockchain-name>  ( <protocol-version> = %d ) [options]        Creates new FFF_Core configuration file %s with default parameters\n",
        ...
        printf("  FFF_Core-util clone <old-blockchain-name> <new-blockchain-name> [options]               Creates new FFF_Core configuration file %s copying parameters\n",fileName);
